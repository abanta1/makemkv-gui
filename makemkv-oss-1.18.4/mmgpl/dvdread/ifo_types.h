...
typedef struct {
  ...
  uint16_t nr_of_cell;
  uint16_t last_byte;
} ATTRIBUTE_PACKED pgc_command_tbl_data_t;
...
} ATTRIBUTE_PACKED pgci_srp_data_t;
...
} ATTRIBUTE_PACKED pgci_lu_data_t;
...
typedef struct {
  ...
  uint16_t zero_1;
  uint32_t last_byte;
} ATTRIBUTE_PACKED pgci_ut_data_t;
...
typedef struct {
  uint32_t last_byte;
} ATTRIBUTE_PACKED vobu_admap_data_t;
...
} ATTRIBUTE_PACKED samg_mat_data_t;
...
} ATTRIBUTE_PACKED tracks_info_table_data_t;
...
typedef struct {
  ...
  uint16_t zero_1;
  uint32_t last_byte;
} ATTRIBUTE_PACKED tt_srpt_data_t;
...
typedef struct {
  ...
  uint16_t zero_2;
} ATTRIBUTE_PACKED ptl_mait_country_data_t;
...
typedef struct {
  ...
  uint16_t nr_of_vtss;
  uint32_t last_byte;
} ATTRIBUTE_PACKED ptl_mait_data_t;
...
typedef struct {
  ...
  uint16_t zero_1;
  uint32_t last_byte;
} ATTRIBUTE_PACKED vts_atrt_data_t;
...
} ATTRIBUTE_PACKED txtdt_lu_data_t;
...
typedef struct {
  ...
  uint32_t last_byte;
} ATTRIBUTE_PACKED txtdt_mgi_data_t;
...
} ATTRIBUTE_PACKED atsi_title_record_data_t;
...
} ATTRIBUTE_PACKED atsi_title_table_data_t;
...
typedef struct {
  ...
  uint16_t zero_1;
  uint32_t last_byte;
} ATTRIBUTE_PACKED vts_ptt_srpt_data_t;
...
} ATTRIBUTE_PACKED vts_tmap_data_t;
...
typedef struct {
  ...
  uint16_t zero_1;
  uint32_t last_byte;
} ATTRIBUTE_PACKED vts_tmapt_data_t;
...
struct pgc_command_tbl_t : pgc_command_tbl_data_t {
    vm_cmd_t* pre_cmds;
    vm_cmd_t* post_cmds;
    vm_cmd_t* cell_cmds;
};

struct pgc_t : pgc_data_t
{
...
struct pgci_srp_t : pgci_srp_data_t
{
    pgc_t* pgc;
};

struct pgcit_t : pgcit_data_t
{
    pgci_srp_t* pgci_srp;
    int      ref_count;
};

struct pgci_lu_t : pgci_lu_data_t
{
    pgcit_t* pgcit;
};

struct pgci_ut_t : pgci_ut_data_t
{
    pgci_lu_t* lu;
};

struct c_adt_t : c_adt_data_t
{
    cell_adr_t* cell_adr_table;  /* No explicit size given. */
};

struct vobu_admap_t : vobu_admap_data_t
{
    uint32_t* vobu_start_sectors;
};

struct tt_srpt_t : tt_srpt_data_t
{
    title_info_t* title;
};

struct ptl_mait_country_t : ptl_mait_country_data_t
{
    pf_level_t* pf_ptl_mai; /* table of (nr_of_vtss + 1), video_ts is first */
};

struct ptl_mait_t : ptl_mait_data_t
{
    ptl_mait_country_t* countries;
};

struct vts_atrt_t : vts_atrt_data_t
{
    vts_attributes_t* vts;
    uint32_t* vts_atrt_offsets; /* offsets table for each vts_attributes */
};

struct txtdt_lu_t : txtdt_lu_data_t
{
    txtdt_t* txtdt;
};

struct txtdt_mgi_t : txtdt_mgi_data_t
{
    txtdt_lu_t* lu;
};

struct ttu_t : ttu_data_t
{
    ptt_info_t* ptt;
};

struct vts_ptt_srpt_t : vts_ptt_srpt_data_t
{
    ttu_t* title;
    uint32_t* ttu_offset; /* offset table for each ttu */
};

struct vts_tmap_t : vts_tmap_data_t
{
    map_ent_t* map_ent;
};

struct vts_tmapt_t : vts_tmapt_data_t
{
    vts_tmap_t* tmap;
    uint32_t* tmap_offset; /* offset table for each tmap */
};

struct samg_mat_t : samg_mat_data_t
{
    samg_chapter_t* samg_chapters;
};

struct tracks_info_table_t : tracks_info_table_data_t
{
    track_info_t* tracks_info;
};

struct atsi_title_record_t : atsi_title_record_data_t
{
...
struct atsi_title_table_t : atsi_title_table_data_t
{
